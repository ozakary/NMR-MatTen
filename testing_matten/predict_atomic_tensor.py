...
def main():
    ...
    model_path = "/scratch/plantto/zakaryou/NMR-ML/matten/2xe_tba_cc3_high-th-level_3125_sanity-checked_dataset/training/matten_logs/matten_proj/ncsgsf99/checkpoints/"
